...
public class ForgotPasswordController {
	/**The corresponding scene of this controller class allows the user to change their password
	 * This scene is accessible to the Admin, Teacher, and Student users*/
	@FXML
